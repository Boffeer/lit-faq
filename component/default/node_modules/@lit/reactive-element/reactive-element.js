...
const e = window.reactiveElementPolyfillSupport,
      r = {
  toAttribute(t, i) {
    switch (i) {
      case Boolean:
...
n.finalized = !0, n.elementProperties = new Map(), n.elementStyles = [], n.shadowRootOptions = {
  ...
  ReactiveElement: n
}), (null !== (s = globalThis.reactiveElementVersions) && void 0 !== s ? s : globalThis.reactiveElementVersions = []).push("1.0.1");
export { n as ReactiveElement, r as defaultConverter, h as notEqual }; //# sourceMappingURL=reactive-element.js.map